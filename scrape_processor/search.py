...
# product_data = []
with open("scrape_processor/search_urls.txt", 'r') as urllist, open('scrape_processor/search_output.jsonl', 'w') as outfile:
    f = open('scrape_processor/product_urls.txt','w')
