...
# product_data = []
with open("scrape_smartphone/search_urls.txt", 'r') as urllist, open('scrape_smartphone/search_output.jsonl', 'w') as outfile:
    f = open('scrape_smartphone/product_urls.txt','w')
